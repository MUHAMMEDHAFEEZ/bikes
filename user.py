...
ASSETS_PATH = OUTPUT_PATH / Path(r"D:\BIKES\build\assets_user\frame0")
...
def enter_data(qt,descz,pricez,totalz):
    ...
    table_create_query = '''CREATE TABLE IF NOT EXISTS bike_data 
...
def add_item1():
    ...
    if(qty1>0):
         ...
         tree.insert('',0, values=invoice_item)
         enter_data(qty1,desc1,price1,line_total1)
...
def add_item2():
    ...
    if(qty2>0):
         ...
         tree.insert('',0, values=invoice_item)
         enter_data(qty2,desc2,price2,line_total2)
...
def add_item3():
    ...
    if(qty3>0):
         ...
         enter_data(qty3,desc3,price3,line_total3)
...
def add_item4():
    ...
    if(qty4>0):
         ...
         enter_data(qty4,desc4,price4,line_total4)
...
def add_item5():
    ...
    if(qty5>0):
         ...
         enter_data(qty5,desc5,price5,line_total5)
...
def add_item6():
    ...
    if(qty6>0):
         ...
         enter_data(qty6,desc6,price6,line_total6)
...
def add_item7():
    ...
    if(qty7>0):
         ...
         enter_data(qty7,desc7,price7,line_total7)
